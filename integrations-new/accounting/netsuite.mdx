...
Connect your NetSuite account to import actuals into Francis. You can connect multiple accounts if you operate across several companies. Once connected, your chart of accounts is available in the [Mappings](/features-new/using-francis/data-mappings) view, where you map NetSuite accounts to line items in your model.
