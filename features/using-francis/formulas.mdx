...
The convention also carries into reporting. Comparisons in [metric boxes](/features/using-francis/metric-box#green-and-red-comparison-colors) and diff columns in variance tables color on direction: up is green, down is red. Costs read correctly there only while they carry their minus.
