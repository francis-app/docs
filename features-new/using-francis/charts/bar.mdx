---
title: "Bar chart"
description: "Horizontal bars comparing values across categories at a fixed date range, for ranking rather than trends."
icon: "chart-bar"
---

<video controls className="w-full aspect-video rounded-xl" src="/videos/features/charts/bar.mp4" />

A bar chart compares values across categories using horizontal bars at a fixed date range, rather than plotting them over time. Use it for ranking, such as the top products by revenue or spend by department. Because the x-axis is categorical, the time-series settings (Aggregate by and Grid) don't apply.
