...
<AccordionGroup>
  ...
  <Accordion title="Series">
    ...
    Series stack as segments within each column. Additional versions of a series render as separate columns side by side for comparison, not as extra segments in the same column. Stack rows, groups, or calculations; use versions to compare them column to column.
