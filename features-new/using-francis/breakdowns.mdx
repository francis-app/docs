...
<Note>Entity breakdown: Holding ApS and Holding Inc. Dimension breakdown (department): Sales, Marketing, Finance. Dimension breakdown (location): Copenhagen, London, New York. Each additional layer multiplies the number of subsheets to maintain.</Note>
...
**Add roll-up** creates a consolidated view of a subset of subsheets. Open the action menu on the parent sheet, choose **Add roll-up**, and drag the relevant subsheets into it. The roll-up shows a combined view of those subsheets without affecting the individual subsheets themselves. Use this when you want a regional or functional consolidation sitting below the full consolidated view.
