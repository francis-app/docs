...
As the name suggests, the *forecast start* indicates the month from which you're currently forecasting. In Francis, every financial plan has a forecast start date. Months before the *Forecast Start* represent actuals, and months after the *Forecast Start* represent your forecast.
...
2. Compare actuals against budget using Francis' built-in variance reporting.
