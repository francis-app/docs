...
3. Enter the invitees email address
4. Select the tole you want the envitee to have when joining
5. Cleck **Invite**. New members will receieve an email with step to join your organization.
