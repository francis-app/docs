...
| Delete organization                      | ✓     |       |        |        |
| Rename organization                      | ✓     | ✓     |        |        |
| Manage and update subscription           | ✓     | ✓     |        |        |
| Manage and update billing details        | ✓     | ✓     |        |        |
| View billing history, including invoices | ✓     | ✓     |        |        |
| Invite and manage members                | ✓     | ✓     |        |        |
| Connect and configure data sources       | ✓     | ✓     | ✓      |        |
| Sync connected data sources              | ✓     | ✓     | ✓      |        |
| Update chart of account mappings         | ✓     | ✓     | ✓      |        |
| Create and edit workbooks                | ✓     | ✓     | ✓      |        |
| Create and edit charts                   | ✓     | ✓     | ✓      |        |
| Create and edit dashboards               | ✓     | ✓     | ✓      |        |
| Set status indicators                    | ✓     | ✓     | ✓      |        |
| Set row descriptions                     | ✓     | ✓     | ✓      |        |
| Configure splits and breakdowns          | ✓     | ✓     | ✓      |        |
| Update forecast start and last close     | ✓     | ✓     | ✓      |        |
| View workbooks and reports               | ✓     | ✓     | ✓      | ✓      |
| View charts and dashboards               | ✓     | ✓     | ✓      | ✓      |
| Downloads reports                        | ✓     | ✓     | ✓      | ✓      |
| Export to Excel                          | ✓     | ✓     | ✓      | ✓      |
| View saved versions                      | ✓     | ✓     | ✓      | ✓      |
| View transactions drill-down             | ✓     | ✓     | ✓      | ✓      |
