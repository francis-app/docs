...
| **Action**                                                    | **Result**                                                                                                                |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| You created an organization “Acme” using `jane.doe@email.com` | An account was created under `jane.doe@email.com`, and a user entry was simultaneously created for the Acme organization. |
| You’re invited to join another organization “Alpha”           | A user entry for `jane.doe@email.com` is created in the Alpha organization.                                               |
