...
<Steps>
  <Step title="Connect your accounting system">
    Before you start modeling, we recommend [connecting](/integrations/accounting/business-central) your accounting system(s). Once you've connected these systems, Francis will sync *all* booked journal entries since inception, giving you full access to all your data.
