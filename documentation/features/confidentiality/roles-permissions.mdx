...
The user who creates an organization is automatically assigned the Owner role. Owners have privileges to invite, remove, promote, and demote team members. They manage members through the *Members* page in settings. Owners have the exclusive privilige to terminate the organization.
...
Admins have mostly the same privileges as Owners, also being able to invite, remove, promote, and demote any team members that is not the Owner. Admins have access to all features and models with the only exception being that Admins don't have the privileges to terminate an organization.
