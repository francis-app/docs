...
Like Excel and Sheets, Francis' formulas use cell references, [functions](/documentation/features/modeling/functions), and mathematical operators. However, Francis uses a slightly different, more human-readable syntax than the A1 notation found in other spreadsheets.
