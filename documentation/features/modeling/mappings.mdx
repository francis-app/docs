...
* **Active**: Accounts with journal entries from any time. The 'Last Activity' identifies the last journal entry. We recommend that you either map or ignore these accounts.&#x20;

* **Unused**: Accounts without journal entries, ever. You do not need to do anything with these; if entries are booked to them later, they will automatically move to the active category.&#x20;
