...
Understanding date settings is essential to leveraging Francis's built-in features. These settings enable core functionalities such as [rolling forecasting](/documentation/version-control/version-control) and [variance analysis](/documentation/variance-analysis/three-column-report). We strongly recommend that users familiarize themselves with the date settings before extensively building their models.
