...
By default, all rales — owners, admins, editors, viewers, and limited viewers — have access to the version timeline and saved versions. It is currently not possible to restrict access to versions or to share individual versions of your model with specific users.&#x20;

If you wish to share specific versions with your team members but do not want to give them access to specific versions, you can export your model to Excel or Sheets or download a regular [PDF](https://docs.francis.app/guides/documentation/reporting/export-to-pdf), which can then be shared with your team.
