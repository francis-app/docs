...
To include draft entries, also know as kassekladder or kladdeposteringer, go to **Settings \> Integrations \> Visma e-conomic**, and enable_Include draft entries (kassekladder)_  in the configuration.
