...
When importing a chart of accounts from Xero, Francis currently doesn't automatically include your retained earnings account. Therefore, you'll need to manually calculate retained earnings on your balance sheet for all entities using Xero.
