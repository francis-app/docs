...
<CardGroup cols={2}>
  ...
  <Card title="Quickbooks" href="/integrations/accounting/quickbooks" img="/images/integrations/accounting/quickbooks/quickbooks-logo-dark.svg" imgStyle={{ maxWidth: '24px', height: 'auto' }} />
