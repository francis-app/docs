...
<AccordionGroup>
  <Accordion title="How do I setup a connection?" defaultOpen={false}>
    For in-depth information on how to set up and configure a connection to your accounting or ERP system, we suggest reviewing the documentation for that specific integration and follow the steps outlined on those pages.
  </Accordion>
