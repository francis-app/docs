...
description: "How to enable and configure your Microsoft Business Central connection."
---
...
To ensure that imported transactions are processed correctly, all general ledger accounts in Business Central must have appropriate account categories assigned. If you have not yet categorized your accounts, or if you need to double-check these settings, go to **Finance > G/L Account Categories** in Business Central to review and confirm that each account is properly classified.
