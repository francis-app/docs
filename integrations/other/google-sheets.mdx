...
<Tabs>
  <Tab title="Monthly totals">
    ...
    For users and organizations on Microsoft 365, it's possible to create a Google account using your Microsoft email, enabling you to add a Google Sheets connection to your organization in Francis.

    <Info>
      We plan to add support for Excel Online during 2025, but are currently exploring the technical requirements. If you have questions about this feature, reach out at [support@francis.app](mailto:support@francis.app).
    </Info>
  </Tab>
