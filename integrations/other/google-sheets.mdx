...
<Tip>
  When you configure this integration, Francis requests permission to access your Google account. Francis will view, edit, create, and delete **only the specific Google Drive files it creates**. It does not request or gain access to any of your other Google Drive files.
</Tip>
