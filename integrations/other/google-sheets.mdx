...
<Tip>
  When you configure this integration, Francis requests permission to access your Google account. Francis can view, edit, create, and delete _only_ the specific Google Drive files it creates. Francis does not request or gain access to any of your other Google Drive files.
</Tip>
...
<Steps>
  ...
  <Step title="Treat as entity">
    ...
    <Info>
      Connecting Google Sheets as an entity counts toward your plan’s limit on active accounting system connections.
    </Info>
  </Step>
  ...
  <Step title="Adjust consolidation set-up (Optional)">
    If you're already consolidating actuals across entities in Francis and want to incorporate accounting data imported from Google Sheets, you'll need to adjust your existing set-up to include this new data source.
