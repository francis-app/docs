...
<Warning>
  You can't switch rate source from a chosen date. Changing the exchange rate source applies to the full history, so closed periods are retranslated at the new rates and your historical figures move. If you have been running on custom rates and want market rates going forward, you have two options: stay on custom rates and keep entering them monthly to preserve historical consistency, or switch to market rates and accept that historical figures will differ. Switching from a specific date is on the roadmap.
</Warning>
