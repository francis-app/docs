...
If you run as a single legal entity, skip the entity breakdown and use a [dimension breakdown](/masterclasses-new/consolidation/dimensions) by department instead. You get the same per-department forecasting without a consolidation layer.
