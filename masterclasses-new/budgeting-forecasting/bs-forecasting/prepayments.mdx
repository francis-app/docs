...
Driver-based is the right primary approach. Build a supporting sheet listing each contract with its payment amount, due month, and coverage period. The sheet flows into both the P&L and the balance sheet — when assumptions change, both update automatically.
