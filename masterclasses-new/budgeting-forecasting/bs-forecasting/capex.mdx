...
<Tabs>
  <Tab title="Driver-based">
    **Set up the supporting sheet**
    ...
    Create one section per asset class: Furniture, Vehicles, Machinery, Intangible assets. Within each section, add a group for new investments. Add one row per asset and hardcode the acquisition cost in the month the asset is acquired. This is your asset register.
    ...
    **Depreciation**
    ...
    When a new asset is added to the register, the depreciation row picks it up in the current period and runs for the full 60 months. Adjust the offset and divisor to match each asset class. Depreciation flows to the P&L as a non-cash expense and to the accumulated depreciation balance on the balance sheet.
