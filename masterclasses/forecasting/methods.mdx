...
<CardGroup cols={2}>
  <Card title="Method">
    Input annual assumptions and divide by twelve to distribute costs equally throughout the year, thereby generating your monthly forecasts.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Method">
    Relevant for cost items that scale with the number of employees, including items such lunch, insurance and office expenses.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Method">
    Instead of formula based forecasting, simply hardcode scheduled expenses and other forecast assumptions directly into your model.
  </Card>
