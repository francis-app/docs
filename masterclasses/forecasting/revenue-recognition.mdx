...
In practice, we consider the following milestones:
...
3. **Invoice:** An invoice is sent. If payment is due later, it creates accounts receivable.
...
In many cases, invoicing and revenue recognition happen simultaneously, such as upon delivery of goods or completion of a service. In these cases, you can forecast recognized and deferred amounts based on invoice data.&#x20;
