...
In practice, the following milestones are relevant to recognize revenue:

1. **Booking:** A contract is signed, but no financial entry is recorded.

2. **Contract start and end dates:** These specify the service period and define when revenue should be recognized based on performance obligations.

3. **Invoice:** The company sends an invoice. If this happens before delivery, it creates deferred revenue. If payment is due later, it creates accounts receivable.

4. **Recognized:** Revenue is recorded on the income statement once the performance obligation is met, typically tied to the contract period or specific delivery milestones.

5. **Receivables is paid:** The customer pays, affecting cash flow but not revenue recognition.

In many cases, invoicing and revenue recognition happen simultaneously, such as upon delivery of goods or completion of a service. In these cases, you can forecast recognized and deferred amoutns based on invoice data.&#x20;

You can also forecast accounts receivables based on invoice data.
...
Here, all recognized and deferred revenue calculations rely on invoiced amounts. Including invoiced amounts is often best done by importing data via the Google Sheets integration, though you can also input them manually. Depending on your business, you may set it up on a customer or product level. If you offer multiple products with different service periods, separate them into individual line items for clarity.
