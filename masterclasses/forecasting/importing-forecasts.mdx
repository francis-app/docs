...
<Tip>
  In Francis, there’s no technical distinction between budgets and forecasts. Any forecast that begins in the first month of your fiscal year functions as your budget, anchor budget, or start-of-year budget.
</Tip>
...
* **Easy customization**: Add rows, groups, or sections to adapt the template to your unique needs.
