...
Use separate accounts or dimensions in your ERP to distinguish cash and non-cash activity. Examples:

- Separate _dividends paid_ (cash) from _retained earnings_ (non-cash).
- Separate _asset additions_ from _accumulated depreciation_.
- Separate _income from subsidiaries_ from other P&L income.
- Separate _non-cash revaluations_ under investments from actual cash movements.
- Track _capitalized salaries_ in a way that the original cash outflow is preserved.
