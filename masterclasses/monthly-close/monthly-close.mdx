...
1. Click **Sync** (top right) to import your booked entries.
2. Set the **Last Close date** to the most recent closed month. This ensures Francis includes the correct periods for actuals.
