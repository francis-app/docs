...
<Steps>
  ...
  <Step title="Check non-cash line items">
    Have all non-cash line items been forecasted correctly? These don't flow through the cash flow statement but still affect the balance sheet. Usual suspects:
