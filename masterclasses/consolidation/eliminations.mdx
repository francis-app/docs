...
* **Same base currency:** A straightforward process, as no currency differences arise.

* **Different base currencies:** Additional steps are required to handle currency exchange rate fluctuations.
