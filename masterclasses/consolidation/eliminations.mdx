...
* **For groups with the same base currency:** A straightforward process, as no currency differences arise.

* **For groups with multiple currencies:** Additional steps are required to handle currency exchange rate fluctuations.
